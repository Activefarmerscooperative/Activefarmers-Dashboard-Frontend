                            ...
                            <div className="row">
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        ...
                                        <input type="text" name="firstname" onChange={handleUserChange} value={userData?.firstname} disabled={!editUser} placeholder="Type Name..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        <label htmlFor="">Last Name</label>
                                        <input type="text" name="surname" onChange={handleUserChange} value={userData?.surname} disabled={!editUser} placeholder="Type Name..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        <label htmlFor="">Email Address</label>
                                        <input type="email" name="email" onChange={handleUserChange} value={userData?.email} disabled={!editUser} placeholder="Type Email.." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                ...
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        ...
                                        <input type="date" name="DOB" disabled={!editUser} onChange={handleUserChange} value={userData?.DOB} placeholder="Type Here..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        <label htmlFor="">Phone Number</label>
                                        <input type="tel" name="phone" disabled placeholder="Type Phone..." value={userData?.phone} className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                            ...
                            <div className="row">
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        ...
                                        <input type="text" name="occupation" value={occupationData?.occupation} onChange={handleOccupationChange} disabled={!editOccupation} placeholder="Type Occupation..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        <label htmlFor=""> Salary(Monthly)</label>
                                        <input type="number" name="salary" value={occupationData?.salary} onChange={handleOccupationChange} disabled={!editOccupation} placeholder="Type Salary..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        <label htmlFor="">Work Level/Grade</label>
                                        <input type="text" name="workLevel" value={occupationData?.workLevel} onChange={handleOccupationChange} disabled={!editOccupation} placeholder="Type Grade..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        <label htmlFor="">Ministry (Company Name)</label>
                                        <input type="text" name="companyName" value={occupationData?.companyName} onChange={handleOccupationChange} disabled={!editOccupation} placeholder="Type Grade..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                {/* <div className="form-group d-flex flex-column mx-3">
                                <label htmlFor="">Last Name</label>
                            ...
                            <div className="row">
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        ...
                                        <input type="text" name="full_name" value={nextKinData?.full_name} onChange={handleNextKinChange} disabled={!editNextKin} placeholder="Type Name..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        <label htmlFor="">Relationship</label>
                                        <input type="text" name="relationship" value={nextKinData?.relationship} onChange={handleNextKinChange} disabled={!editNextKin} placeholder="Type Relationship..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        <label htmlFor="">Home Address</label>
                                        <input type="text" name="address" value={nextKinData?.address} onChange={handleNextKinChange} disabled={!editNextKin} placeholder="Type Address..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        <label htmlFor="">Phone Number</label>
                                        <input type="tel" name="phone" value={nextKinData?.phone} onChange={handleNextKinChange} disabled={!editNextKin} placeholder="Type Phone..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                                ...
                                <div className="col-md-4 col-sm-6">
                                    <div className="form-group d-flex flex-column mx-3">
                                        <label htmlFor="">Email Address</label>
                                        <input type="email" name="email" value={nextKinData?.email} onChange={handleNextKinChange} disabled={!editNextKin} placeholder="Type Email..." className={editUser ? "editable-input" : ""} />
                                    </div>
                                </div>
                            </div>
